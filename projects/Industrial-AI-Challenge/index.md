...
![Fedrigoni Industrial AI Challenge preview](/projects/Industrial-AI-Challenge/Fedrigoni.avif)
...
- Understanding the production-management problem and translating it into an AI use case.
- Supporting process analysis and industrial-engineering framing.
- Participating in data analysis, feature engineering, and model-evaluation discussions.
- Connecting model outputs to operational decisions such as capacity visibility, workload planning, and service reliability.
- Helping communicate the value of the solution from both technical and managerial perspectives.

## What I Learned

This challenge reinforced several lessons that are central to industrial AI:

- A good model starts with a good operational question.
- Manufacturing data needs process context; columns alone are not enough.
- Forecasting is only useful if it supports a decision.
- Time-aware validation matters when the use case is future planning.
- Adoption depends on trust, interpretability, usability, and fit with existing workflows.
- AI in manufacturing should augment planners, operators, and engineers rather than bypass them.
...
- [Certificate of Attendance](/projects/Industrial-AI-Challenge/Certificate.png)
